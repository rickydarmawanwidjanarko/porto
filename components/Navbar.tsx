    ...
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between ">
        ...
        <div className="hidden mdl:inline-flex item-center gap-7">
          ...
          <a
            href="/assets/CV Ricky Darmawan Widjanarko.pdf"
            target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <a href="/assets/CV Ricky Darmawan Widjanarko.pdf" target="_blank">
                  <motion.button
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                <div className="flex gap-4">
                  <motion.a
                    ...
                    href="https://github.com/rickydarmawanwidjanarko"
                    target="_blank"
                  >
                  ...
                  <motion.a
                    ...
                    href="https://www.linkedin.com/in/rickydarwid/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textOrange text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textOrange cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialLinkedin />
              ...
              <motion.a
                ...
                className="text-sm w-72 tracking-widest text-textOrange text-center mt-4"
                href="mailto:rickydw98@gmail.com"
              >
                <p>rickydw98@gmail.com</p>
              </motion.a>
            </motion.div>
          </div>
        )}
