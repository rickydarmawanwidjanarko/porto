...
//                         <div className="w-full relative z-20 flex pl-9 lgl:pl-9">
//                             <Image
//                                 className="rounded-full h-full"
//                                 src={profileImg}
//                                 alt="profileImg"
//                             />
//                             {/* <div className="hidden lgl:inline-block absolute w-80 h-80 bg-textOrange/20 rounded-md top-0 left-0 group-hover:bg-transparent duration-300"></div> */}
//                         </div>
//                     </div>
